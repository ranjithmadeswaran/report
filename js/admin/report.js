...
if (pageValue === "admin.payment-report") {
    ...
    $(document).ready(function () {
        ...
        dateInput.on("apply.daterangepicker", function (ev, picker) {
            ...
            paymentReportList(filter_date, filter_payment, filter_type, filter_sort);
        });
    ...
    function paymentReportList(filter_date, filter_payment, filter_type, filter_sort) {
        // Get filter values
        let dateRange = filter_date;

        // Send AJAX request with filters
        $.ajax({
            url: "/api/paymentreportlist",
            type: "POST",
            headers: {
            ...
            success: function (response) {
                if (
                    ...
                    let totalSubscriptionAmount =
                        response.data.total_subscription_amount || "0.00";
                    ...
                    $("#subscription-payments h5").text(
                        currency_total + totalSubscriptionAmount
                    );
